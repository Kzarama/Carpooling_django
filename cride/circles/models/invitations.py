...
class Invitation(CRideModel):
    """Circle Invitation
    A circle invitation is a random text that acts as a unique code
    that grants access to a specific circle.
    This codes are generated by users that are already members of the
    circle and have a `remaining_invitations` value greater than 0
    """
